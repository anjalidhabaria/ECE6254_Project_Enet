...
# Credits: Following class code is borrowed davidtvs/PyTorch-ENet                            
##################################################################
import os
...
class Cityscapes(data.Dataset):
    ...
    def __init__(self,
        ...
        if self.mode.lower() == 'train':
            ...
            self.train_instance = utils.get_files(
                os.path.join(root_dir, self.train_lbl_folder),
                name_filter=self.inst_name_filter,
                extension_filter=self.img_extension)

            self.train_depth = utils.get_files(
            ...
            self.val_instance = utils.get_files(
                os.path.join(root_dir, self.val_lbl_folder),
                name_filter=self.inst_name_filter,
                extension_filter=self.img_extension)

            self.val_depth = utils.get_files(
            ...
            self.test_instance = utils.get_files(
                os.path.join(root_dir, self.test_lbl_folder),
                name_filter=self.inst_name_filter,
                extension_filter=self.img_extension)

            self.test_depth = utils.get_files(
